"""
Competitive Analysis Orchestrator (SeleniumBase Version)

Integrates all competitive intelligence components with SeleniumBase drivers:
...
Usage:
    ...
    ca = CompetitiveAnalysisSelenium()
...
class CompetitiveAnalysisSelenium(BaseSeleniumScraper):
    """
    Unified competitive intelligence orchestrator using SeleniumBase.
...
_competitive_analysis_selenium_instance = None


def get_competitive_analysis_selenium() -> CompetitiveAnalysisSelenium:
    """Get or create the singleton CompetitiveAnalysisSelenium instance."""
    global _competitive_analysis_selenium_instance

    if _competitive_analysis_selenium_instance is None:
        _competitive_analysis_selenium_instance = CompetitiveAnalysisSelenium()

    return _competitive_analysis_selenium_instance
