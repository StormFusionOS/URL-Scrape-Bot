"""
Keyword Intelligence Orchestrator

Integrates all keyword intelligence components:
...
Usage:
    from seo_intelligence.scrapers.keyword_intelligence import KeywordIntelligence
...
from seo_intelligence.scrapers.autocomplete_scraper import (
    AutocompleteScraper, AutocompleteSuggestion, get_autocomplete_scraper
)
...
class KeywordIntelligence(BaseScraper):
    """
    Unified keyword intelligence orchestrator.
    ...
    def __init__(
        ...
        self.logger = get_logger("keyword_intelligence")

        # Initialize components
        self.autocomplete_scraper = get_autocomplete_scraper()
    ...
    def analyze_keyword(
        ...
        # 5. Get related keywords (optional)
        related_keywords = []
        if include_related:
...
_keyword_intelligence_instance = None


def get_keyword_intelligence() -> KeywordIntelligence:
    """Get or create the singleton KeywordIntelligence instance."""
    global _keyword_intelligence_instance

    if _keyword_intelligence_instance is None:
        _keyword_intelligence_instance = KeywordIntelligence()

    return _keyword_intelligence_instance
