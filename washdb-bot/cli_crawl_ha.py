#!/usr/bin/env python3
"""
CLI wrapper for HomeAdvisor crawler - runs as standalone subprocess.
...
def main():
    parser = argparse.ArgumentParser(description='Run HomeAdvisor crawler')
    ...
    print(f"Starting HomeAdvisor Crawler")
