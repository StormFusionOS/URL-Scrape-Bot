#!/usr/bin/env python3
"""
LRU HTML Parsing Cache for Yellow Pages Scraper
...
class HTMLCache:
    ...
    def __init__(self, max_size: int = 1000, ttl_hours: float = 2.0):
        ...
        logger.info(f"HTMLCache initialized: max_size={max_size}, ttl={ttl_hours}h")
    ...
    if _html_cache is None:
        with _cache_lock:
            if _html_cache is None:
                ...
                logger.info(f"Global HTML cache created: max_size={max_size}, ttl={ttl_hours}h")
