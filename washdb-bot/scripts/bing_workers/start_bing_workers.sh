#!/bin/bash
###############################################################################
# Bing Local Search City-First Crawler - 5 Worker Deployment Script
###############################################################################
...
#
# Usage:
#   ./scripts/bing_workers/start_bing_workers.sh
#
...
echo "========================================================================"
echo "Bing Local Search City-First Crawler - Starting 5 Workers"
echo "========================================================================"
...
# Stop any existing Bing workers
echo "Stopping any existing Bing workers..."
bash scripts/bing_workers/stop_bing_workers.sh 2>/dev/null
...
nohup python3 cli_crawl_bing_city_first.py \
    --worker-id 1 \
    --log-file logs/bing_worker_1.log \
...
echo "  → Log: logs/bing_worker_1.log"
echo ""
...
nohup python3 cli_crawl_bing_city_first.py \
    --worker-id 2 \
    --log-file logs/bing_worker_2.log \
...
echo "  → Log: logs/bing_worker_2.log"
echo ""
...
nohup python3 cli_crawl_bing_city_first.py \
    --worker-id 3 \
    --log-file logs/bing_worker_3.log \
...
echo "  → Log: logs/bing_worker_3.log"
echo ""
...
nohup python3 cli_crawl_bing_city_first.py \
    --worker-id 4 \
    --log-file logs/bing_worker_4.log \
...
echo "  → Log: logs/bing_worker_4.log"
echo ""
...
nohup python3 cli_crawl_bing_city_first.py \
    --worker-id 5 \
    --log-file logs/bing_worker_5.log \
...
echo "  → Log: logs/bing_worker_5.log"
echo ""
...
echo "========================================================================"
echo "PIDs saved to: logs/bing_workers.pid"
echo ""
echo "Monitor workers:"
echo "  ./scripts/bing_workers/check_bing_workers.sh"
echo ""
echo "Stop workers:"
echo "  ./scripts/bing_workers/stop_bing_workers.sh"
echo ""
echo "View logs:"
