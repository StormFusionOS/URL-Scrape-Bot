#!/usr/bin/env python3
"""
Launch script for 10-worker state-partitioned scraping system.
...
Usage:
    ...
    python scripts/run_state_workers.py --workers 10
    python scripts/run_state_workers.py --test  # Test with 2 workers only
"""
...
logger = get_logger("run_state_workers")
    ...
    try:
        ...
        if grand_total > 0:
            ...
            if overall_progress > 0 and total_done > 0:
                # Assume 10 workers, ~3 targets/min/worker = 30 targets/min
