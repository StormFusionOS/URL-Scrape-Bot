...
DEFAULT_CONFIG = {
    ...
    "paths": {
        "log_dir": "/opt/ai-seo/logs/url-scrape-bot",
        "export_dir": "/opt/ai-seo/state/url-scrape-bot/exports",
    },
    "defaults": {
        "crawl_delay": 1.0,
        "pages_per_pair": 1,
...
class ConfigManager:
    ...
    def __init__(self, config_path: str = "/opt/ai-seo/config/url-scrape-bot/config.json"):
